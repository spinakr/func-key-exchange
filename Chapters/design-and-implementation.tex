...
\section{Models and Construction}\label{sec:models}
...
\begin{figure}[H]
\centering
\includegraphics[trim=1cm 2cm 0cm 3cm ,scale=0.9]{Flow.pdf}
\caption{System flow.}
\label{fig:flow}
\end{figure}
...
\section{Security Concerns}\label{sec:concerns}
...
\begin{figure}[h]
\centering
\includegraphics[trim=1cm 0cm 2cm 3cm ,scale=0.9]{server-state.pdf}
